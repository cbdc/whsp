<resource schema="whsp">
  ...
  <table id="main" onDisk="True" mixin="//scs#q3cindex" primary="id" adql="True">
    ...
    <column name="asdc_link" type="text"
      tablehead="asdc sed tool" verbLevel="1"
    />
  ...
  <service id="cone" allowed="scs.xml,form">
    ...
    <outputTable verbLevel="20">
      <outputField original="asdc_link" select="array[raj2000,decj2000]">
        <formatter><![CDATA[
          _ra = data[0]
          _dec = data[1]
          _url = 'http://tools.asdc.asi.it/SED/sed.jsp?&ra=%s&dec=%s' % (str(_ra),str(_dec))
          yield T.a(href="%s"%_url , target="_blank")["ASDC/SED tool"]
        ]]></formatter>
      </outputField>
    </outputTable>
